  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested contact" do
        ...
        contact.reload
        expect(contact.first_name).to eq('FirstName_update')
        expect(contact.last_name).to eq('LastName_update')
        expect(contact.phone_mobile).to eq('+18005550000')
      end
